"""
Repository de Filtros - Queries para popular dropdowns dinamicamente
Consulta valores únicos das tabelas de dados
"""
...
def get_distinct_clients_corretiva():
    ...
    try:
        ...
        print(f"[REPOSITORY_FILTERS] Erro ao buscar clientes corretiva: {e}")
        return []
...
def get_distinct_clients_preventiva():
    ...
    try:
        ...
        print(f"[REPOSITORY_FILTERS] Erro ao buscar clientes preventiva: {e}")
        return []
...
def get_distinct_months():
    ...
    try:
        ...
        print(f"[REPOSITORY_FILTERS] Erro ao buscar meses: {e}")
        return []
...
def get_distinct_pecas():
    ...
    try:
        ...
        print(f"[REPOSITORY_FILTERS] Erro ao buscar peças: {e}")
        return []
...
def get_distinct_tipo_mo():
    ...
    try:
        ...
        print(f"[REPOSITORY_FILTERS] Erro ao buscar tipo_mo: {e}")
        return []
...
def get_distinct_planos():
    ...
    try:
        ...
        print(f"[REPOSITORY_FILTERS] Erro ao buscar planos: {e}")
        return []
...
def get_value_range_stats():
    ...
    try:
        ...
        print(f"[REPOSITORY_FILTERS] Erro ao buscar range de valores: {e}")
        return {"min": 0, "max": 50000, "median": 5000}
...
def get_tooltip_data_corretiva(mes: str = None):
    ...
    try:
        ...
        print(f"[REPOSITORY_FILTERS] Erro ao buscar tooltip data: {e}")
        return {"top_clientes": [], "top_pecas": [], "top_tipo_mo": []}
